...
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    ...
    <img src="../../img/edit.gif" class ="img" width="70px" margin-top="0px" text-align="center" >
			<form method="POST">
				...
				<input type="date" name="bday" 	class="form" value="<?php echo $user_data['bday']; ?>">
